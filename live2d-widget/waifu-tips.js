...
function initWidget(waifuPath = "/waifu-tips.json", apiPath = "") {
	...
	$("body").append(`<div id="waifu">
			...
			<canvas id="live2d" width="250" height="220"></canvas>
			<div id="waifu-tool">
				<div class="live2d-tool switch-live2d no-select">
				switch</div>
			    <!div class="live2d-tool hide-live2d no-select" >
				<!/div>
				<div class="live2d-tool save-live2d no-select">
				save</div>
		</div>`);

	function registerEventListener() {
		$("#waifu-tool .fa-comment").click(showHitokoto);
		$("#waifu-tool .hide-live2d").click(function() {
			var s = document.createElement("script");
			document.body.appendChild(s);
			s.src = "https://galaxymimi.com/js/asteroids.js";
		});
		$("#waifu-tool .fa-user-circle").click(loadOtherModel);
		$("#waifu-tool .switch-live2d").click(loadRandModel);
		$("#waifu-tool .save-live2d").click(function() {
	...
	function loadRandModel() {
		var modelId = localStorage.getItem("modelId"),
			...
			modelTexturesId =Math.floor(Math.random() * 100 + 1)
